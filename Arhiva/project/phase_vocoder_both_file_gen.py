...
def phase_vocoder_article(signal, tsm_rate, psm_rate, window_size=1024, hop_size=256):
    """
    Modified phase vocoder for time-stretching and pitch-scaling an audio signal based on the new method.

    :param signal: Input audio signal (1D numpy array).
    :param tsm_rate: Time-stretching factor (greater than 1 for stretching, less than 1 for shrinking).
    :param psm_rate: Pitch-scaling factor (greater than 1 for pitch up, less than 1 for pitch down).
...
def phase_vocoder_2(signal, tsm_rate, psm_rate, window_size=1024, hop_size=256):
    """
    Phase vocoder for time-stretching and pitch-scaling an audio signal.
